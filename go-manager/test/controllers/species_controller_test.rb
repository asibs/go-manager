...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { monster_no: @species.monster_no, name: @species.name } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { monster_no: @species.monster_no, name: @species.name } }
