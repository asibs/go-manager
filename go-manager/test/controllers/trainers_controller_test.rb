...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { current_level: @trainer.current_level, name: @trainer.name, team_id: @trainer.team_id } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { current_level: @trainer.current_level, name: @trainer.name, team_id: @trainer.team_id } }
