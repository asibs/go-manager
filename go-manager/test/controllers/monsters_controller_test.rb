...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { name: @monster.name, user_id: @monster.user_id } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { name: @monster.name, user_id: @monster.user_id } }
